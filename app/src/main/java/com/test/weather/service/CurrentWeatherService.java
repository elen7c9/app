...
import com.test.weather.ConnectionDetector;
...
import static com.test.weather.MainActivity.mCitySearch;
import static com.test.weather.MainActivity.mWeather;

public class CurrentWeatherService extends IntentService {

    private static final String TAG = "WeatherService";

    public static final String ACTION_WEATHER_UPDATE_OK = "com.test.weather.action.WEATHER_UPDATE_OK";
    public static final String ACTION_WEATHER_UPDATE_FAIL = "com.test.weather.action.WEATHER_UPDATE_FAIL";
    public static final String ACTION_WEATHER_UPDATE_RESULT = "com.test.weather.action.WEATHER_UPDATE_RESULT";
