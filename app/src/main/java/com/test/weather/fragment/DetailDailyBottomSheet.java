package com.test.weather.fragment;
...
public class DetailDailyBottomSheet extends BottomSheetDialogFragment {

    private DailyWeather mWeather;

    public DetailDailyBottomSheet newInstance(DailyWeather weather) {
        DetailDailyBottomSheet fragment = new DetailDailyBottomSheet();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWeather = (DailyWeather) getArguments().getSerializable("weatherForecast");
    }
